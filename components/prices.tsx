...
export const Prices = () => {
  ...
  return (
    <section className="py12 lg:py-24" id="prices">
      <div className="container">
        <div className="mb-20 text-center">
          <p className="mb-3 text-orange font-semibold capitalize">
            Our Grooming Prices
          </p>
          <h2 className="h2 mb-3">How Big Is Your Dog?</h2>
          <p className="text-lg text-blue">
            Choose the right size category to see grooming packages and costs
          </p>
        </div>
